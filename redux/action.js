...
const serverUrl = 'https://jade-breakable-lion.cyclic.app/api/v1';
...
export const registerProfile = (name,email,password, avatar) => async dispatch => {
  try {
...
export const forgetpasswordPassword = (email) => async dispatch => {
  try {
